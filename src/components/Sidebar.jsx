...
function Sidebar() {
	...
	return (
		<>
			<button onClick={() => setIsOpen(!isOpen)} className='lg:hidden p-4 focus:outline-none fixed top-0 left-0 z-50'>
				<ion-icon name={isOpen ? "close-outline" : "menu-outline"} size='large'></ion-icon>
			</button>
			...
			>
				<div className='h-full overflow-y-auto'>
					...
					<div className='w-3/4 bg-blue-600 lg:pr-4 rounded-full text-white mx-auto justify-center flex flex-row lg:space-x-2'>
						<Avatar className='my-auto font-bold lg:block hidden' isBordered color='primary' />
					...
					<ul className='space-y-2 font-medium mx-4'>
						<li>
							<Button
								...
								variant='light'
								color='primary'
								className={`${location.pathname == "/" && "bg-blue-500 text-white"} w-full justify-start`}
								radius='sm'
						...
						<li>
							<Button
								...
								variant='light'
								color='primary'
								className={`${location.pathname == "/products" && "bg-blue-500 text-white"} w-full justify-start`}
								radius='sm'
						...
						<li>
							<Button
								...
								variant='light'
								color='primary'
								className={`${location.pathname == "/customers" && "bg-blue-500 text-white"} w-full justify-start`}
								radius='sm'
						...
						<li>
							<Button
								...
								variant='light'
								color='primary'
								className={`${location.pathname == "/bills" && "bg-blue-500 text-white"} w-full justify-start`}
								radius='sm'
						...
						{user.role == "admin" && (
							<li>
								<Button
									...
									variant='light'
									color='primary'
									className={`${location.pathname == "/users" && "bg-blue-500 text-white"} w-full justify-start`}
									radius='sm'
									startContent={<ion-icon name='people-outline'></ion-icon>}
								>
									<span className='ms-3 text-medium font-semibold'>Users</span>
								</Button>
							</li>
						)}
