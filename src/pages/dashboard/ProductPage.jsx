...
const ProductPage = () => {
  ...
  return (
    <Card className="flex flex-1 justify-center m-8">
      <CardHeader className="my-4 flex justify-between items-center">
        <div className="">
          <h1 className="text-xl font-bold p-2">Daftar Produk</h1>
          <AddProductModal />
        </div>
        <div className="relative w-auto">
          <Search color={"#606060"} className="absolute top-2.5 right-3" />
          <input
            type="text"
            placeholder="Search..."
