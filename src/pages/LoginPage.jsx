            ...
            <div className="w-full max-w-xl mb-12 xl:mb-0 xl:w-2/3">
              <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-white sm:text-4xl sm:leading-none">
                ...
                <span className="text-3xl">
                  – Log in to Manage Laundry Service
                </span>
              </h2>
              <p className="max-w-xl mb-4 text-base text-gray-200 md:text-lg">
                Welcome to Enigma Laundry. Please log in to access our premium
                laundry services that are easy, fast, and efficient. Keep your
                clothes fresh with just one click!
              </p>
            </div>
